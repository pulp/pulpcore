...
#### Bugfixes {: #3.85.21-rest-api-bugfix }

- Fixed cache forgetting the Content-Type header of ApiResponses

### Plugin API {: #3.85.21-plugin-api }

No significant changes.

### Pulp File {: #3.85.21-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.85.21-pulp-cert-guard }
...
## 3.85.14 (2026-03-17) {: #3.85.14 }

### REST API {: #3.85.14-rest-api }

#### Bugfixes {: #3.85.14-rest-api-bugfix }
...
### Plugin API {: #3.85.14-plugin-api }

No significant changes.

### Pulp File {: #3.85.14-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.85.14-pulp-cert-guard }
...
### Plugin API {: #3.85.12-plugin-api }

No significant changes.

### Pulp File {: #3.85.12-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.85.12-pulp-cert-guard }
...
## 3.73.29 (2026-03-17) {: #3.73.29 }

### REST API {: #3.73.29-rest-api }

#### Bugfixes {: #3.73.29-rest-api-bugfix }
...
### Plugin API {: #3.73.29-plugin-api }

No significant changes.

### Pulp File {: #3.73.29-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.73.29-pulp-cert-guard }

No significant changes.

---

## 3.73.28 (2026-03-10) {: #3.73.28 }

### REST API {: #3.73.28-rest-api }

#### Bugfixes {: #3.73.28-rest-api-bugfix }
...
### Plugin API {: #3.73.28-plugin-api }

No significant changes.

### Pulp File {: #3.73.28-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.73.28-pulp-cert-guard }

No significant changes.

---

## 3.73.27 (2026-02-25) {: #3.73.27 }

### REST API {: #3.73.27-rest-api }

No significant changes.

### Plugin API {: #3.73.27-plugin-api }

No significant changes.

### Pulp File {: #3.73.27-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.73.27-pulp-cert-guard }
...
### Plugin API {: #3.73.22-plugin-api }

No significant changes.

### Pulp File {: #3.73.22-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.73.22-pulp-cert-guard }
...
## 3.63.39 (2026-05-13) {: #3.63.39 }

### REST API {: #3.63.39-rest-api }

#### Bugfixes {: #3.63.39-rest-api-bugfix }

- Fixed cache forgetting the Content-Type header of ApiResponses

### Plugin API {: #3.63.39-plugin-api }

No significant changes.

### Pulp File {: #3.63.39-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.63.39-pulp-cert-guard }
...
#### Bugfixes {: #3.63.32-rest-api-bugfix }
...
### Plugin API {: #3.63.32-plugin-api }

No significant changes.

### Pulp File {: #3.63.32-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.63.32-pulp-cert-guard }

No significant changes.

---

## 3.63.31 (2026-02-25) {: #3.63.31 }

### REST API {: #3.63.31-rest-api }

No significant changes.

### Plugin API {: #3.63.31-plugin-api }

No significant changes.

### Pulp File {: #3.63.31-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.63.31-pulp-cert-guard }
...
## 3.49.56 (2026-03-17) {: #3.49.56 }

### REST API {: #3.49.56-rest-api }

#### Bugfixes {: #3.49.56-rest-api-bugfix }
...
### Plugin API {: #3.49.56-plugin-api }

No significant changes.

### Pulp File {: #3.49.56-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.49.56-pulp-cert-guard }
...
### Plugin API {: #3.49.54-plugin-api }

No significant changes.

### Pulp File {: #3.49.54-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.49.54-pulp-cert-guard }

No significant changes.

---

## 3.49.53 (2026-03-03) {: #3.49.53 }

### REST API {: #3.49.53-rest-api }

No significant changes.

### Plugin API {: #3.49.53-plugin-api }

No significant changes.

### Pulp File {: #3.49.53-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.49.53-pulp-cert-guard }

No significant changes.

---

## 3.49.52 (2026-02-25) {: #3.49.52 }

### REST API {: #3.49.52-rest-api }

No significant changes.

### Plugin API {: #3.49.52-plugin-api }

No significant changes.

### Pulp File {: #3.49.52-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.49.52-pulp-cert-guard }

No significant changes.

---

## 3.49.51 (2026-02-24) {: #3.49.51 }

### REST API {: #3.49.51-rest-api }

#### Bugfixes {: #3.49.51-rest-api-bugfix }

- Fixed not supporting the new rename of the S3 storage backend.
  [#7228](https://github.com/pulp/pulpcore/issues/7228)

### Plugin API {: #3.49.51-plugin-api }

No significant changes.

### Pulp File {: #3.49.51-pulp-file }

No significant changes.

### Pulp Cert Guard {: #3.49.51-pulp-cert-guard }
