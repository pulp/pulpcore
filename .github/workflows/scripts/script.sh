...
if [[ "${RELEASE_WORKFLOW:-false}" == "true" ]]; then
  ...
  REPORTED_VERSION=$(http $STATUS_ENDPOINT | jq --arg plugin pulpcore --arg legacy_plugin pulpcore -r '.versions[] | select(.component == $plugin or .component == $legacy_plugin) | .version')
