...
pulp_settings: {"allowed_export_paths": ["/tmp"], "allowed_import_paths": ["/tmp"], "api_root": "/pulp/", "content_path_prefix": "/somewhere/else/", "orphan_protection_time": 0, "task_protection_time": 10, "tmpfile_protection_time": 10, "upload_protection_time": 10}
pulp_scheme: "https"
image:
  name: "pulp"
  tag: "ci_build"
...
if [ "$TEST" = "gcp" ]; then
  ...
  - name: "ci-gcp"
    ...
    command: " -scheme http"
gcp_test: true
pulp_scenario_settings: {"STORAGES": {"default": {"BACKEND": "storages.backends.gcloud.GoogleCloudStorage", "OPTIONS": {"bucket_name": "gcppulp", "custom_endpoint": "http://ci-gcp:4443"}}, "staticfiles": {"BACKEND": "django.contrib.staticfiles.storage.StaticFilesStorage"}}}
pulp_scenario_env: {}
VARSYAML
fi
