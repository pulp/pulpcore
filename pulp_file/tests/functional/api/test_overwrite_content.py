...
def test_modify_overwrite_false_rejects_overwrite(
    ...
    """Adding content with a conflicting relative_path and overwrite=False fails the task."""
    ...
    # Attempt to add the second content unit with overwrite=False — expect task error
