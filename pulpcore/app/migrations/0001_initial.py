...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "artifact",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.PROTECT, to="core.Artifact"
                    ),
                ),
                (
                    "content",
            ...
            options={"unique_together": {("content", "relative_path")}},
            bases=(models.Model, pulpcore.app.models.content.QueryMixin),
        ),
        migrations.CreateModel(
            name="ContentGuard",
        ...
        migrations.CreateModel(
            ...
            options={"default_related_name": "exporters"},
        ),
        migrations.CreateModel(
            name="Publisher",
            fields=[
            ...
            options={"default_related_name": "publishers"},
        ),
        migrations.CreateModel(
            name="Remote",
            fields=[
            ...
            options={"default_related_name": "remotes"},
        ),
        migrations.CreateModel(
            name="Repository",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.ReservedResource"
                    ),
                ),
                (
                    "task",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="reserved_resources",
                through="core.TaskReservedResource",
                to="core.Task",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "count_type",
                    models.CharField(
                        choices=[("A", "added"), ("P", "present"), ("R", "removed")], max_length=1
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "publisher",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="core.Publisher"
                    ),
                ),
                (
                    "repository_version",
        ...
        migrations.CreateModel(
            ...
            options={"unique_together": {("content_artifact", "remote")}},
            bases=(models.Model, pulpcore.app.models.content.QueryMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=255,
                        upload_to=pulpcore.app.models.publication.PublishedMetadata._storage_path,
                    ),
                ),
                (
                    "publication",
