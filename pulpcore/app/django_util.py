...
def cascade_delete(from_model, instance_pk_query, skip_relations=None, base_model=None, level=0):
    ...
    for model_relation in from_model._meta.related_objects:
        ...
        LOG.debug(f"Relation from {base_model} to {related_model}: on_delete={model_relation.on_delete}")
        ...
        if not model_relation.on_delete:
            ...
            pass
        # elif model_relation.on_delete.__name__ == "PROTECT":
        #     raise models.ProtectedError("")
        # elif model_relation.on_delete.__name__ == "RESTRICT":
        #     raise models.ProtectedError("")
        # elif model_relation.on_delete.__name__ == "DO_NOTHING":
        #     raise models.ProtectedError("")
        # elif model_relation.on_delete.__name__ == "SET":
        #     raise models.ProtectedError("")
        # elif model_relation.on_delete.__name__ == "SET_DEFAULT":
        #     raise models.ProtectedError("")
