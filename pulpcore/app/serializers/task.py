...
class WorkerSerializer(ModelSerializer):
    ...
    online = serializers.BooleanField(
        help_text=_("True if the worker is considered online, otherwise False"), read_only=True
    )
    missing = serializers.BooleanField(
        help_text=_("True if the worker is considerd missing, otherwise False"), read_only=True
    )
