...
class RepositorySerializer(ModelSerializer):
    _href = IdentityField(view_name="repositories-detail")
    _versions_href = IdentityField(view_name="versions-list", lookup_url_kwarg="repository_pk")
...
class RemoteSerializer(MasterModelSerializer):
    ...
    validate = serializers.BooleanField(
        help_text="If True, the plugin will validate imported artifacts.", required=False
    )
    ...
    ssl_validation = serializers.BooleanField(
        help_text="If True, SSL peer validation must be performed.", required=False
    )
...
class PublisherSerializer(MasterModelSerializer):
    ...
    class Meta:
        ...
        fields = MasterModelSerializer.Meta.fields + ("name", "_last_updated")
...
class ExporterSerializer(MasterModelSerializer):
    ...
    class Meta:
        ...
        fields = MasterModelSerializer.Meta.fields + ("name", "_last_updated", "last_export")
...
class RepositoryVersionCreateSerializer(ModelSerializer, NestedHyperlinkedModelSerializer):
    add_content_units = serializers.ListField(
        help_text=_("A list of content units to add to a new repository version"), write_only=True
    )
