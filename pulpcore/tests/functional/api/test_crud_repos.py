...
class CRUDRepoTestCase(unittest.TestCase):
    ...
    def test_02_create_same_name(self):
        ...
        * `Pulp Smash #1055
        ...
        response = self.client.post(REPO_PATH, gen_repo(name=self.repo["name"]))
    ...
    def test_02_read_repo_with_specific_fields(self):
        ...
        for field_pair in permutations(fields, 2):
            ...
            with self.subTest(field_pair=field_pair):
                repo = self.client.get(self.repo["_href"], params={"fields": ",".join(field_pair)})
    ...
    def test_02_read_repos(self):
        ...
        page = self.client.get(REPO_PATH, params={"name": self.repo["name"]})
    ...
    def test_negative_create_repo_with_invalid_parameter(self):
        ...
        """
        response = api.Client(self.cfg, api.echo_handler).post(REPO_PATH, gen_repo(foo="bar"))
