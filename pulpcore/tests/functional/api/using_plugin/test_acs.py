...
class AlternateContentSourceTestCase(unittest.TestCase):
    ...
    def test_create_without_paths(self):
        ...
        self.assertEqual(len(self.file_acs_api.list().results), 1)
    ...
    def test_create_acs_with_paths(self):
        ...
        self.assertEqual(acs.paths, json.loads(self.paths))
    ...
    def test_acs_update(self):
        ...
        self.assertEqual(acs.paths, json.loads(self.paths_updated))
