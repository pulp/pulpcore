...
class AccessPolicyFromDB(AccessPolicy):
    ...
    def __init_subclass__(self, *args, **kwargs):
        deprecation_logger.warning(
            "AccessPolicyFromDB is deprecated. It will be removed no later than pulpcore 4.0. "
            "Please consider inheriting from DefaultAccessPolicy or AccessPolicyFromSettings "
            "instead."
        )
