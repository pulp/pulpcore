...
In your plugin code, subclass `ContentGuard` and optionally add additional fields as necessary to define how authentication and authorization is to be performed.
